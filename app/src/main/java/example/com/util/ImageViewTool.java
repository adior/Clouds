...
public class ImageViewTool {
    public static void matchAll(Context context, ImageView imageView,int columnCount) {
        ...
        //获取屏幕columnCount分之一长度 即image宽
        int ssWidth = sWidth/columnCount;
        //获取图片宽高
        ...
        //计算imageView高
        int image_height =  (int)(ssWidth/dScale*1.2);
        /*
        缩放比
        ...
        //重设ImageView宽高
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ssWidth,image_height);
